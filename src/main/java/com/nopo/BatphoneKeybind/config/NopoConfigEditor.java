...
import com.nopo.BatphoneKeybind.core.GlScissorStack;
import com.nopo.BatphoneKeybind.core.GuiElement;
import com.nopo.BatphoneKeybind.core.GuiElementTextField;
import com.nopo.BatphoneKeybind.core.config.Config;
import com.nopo.BatphoneKeybind.core.config.gui.GuiOptionEditor;
import com.nopo.BatphoneKeybind.core.config.gui.GuiOptionEditorAccordion;
import com.nopo.BatphoneKeybind.core.config.struct.ConfigProcessor;
import com.nopo.BatphoneKeybind.core.util.lerp.LerpUtils;
import com.nopo.BatphoneKeybind.core.util.lerp.LerpingInteger;
...
import com.nopo.BatphoneKeybind.util.Utils;
...
public class NopoConfigEditor extends GuiElement {

    public static NopoConfigEditor editor = new NopoConfigEditor(NopoMod.INSTANCE.config);
    ...
    private static final ResourceLocation SEARCH_ICON = new ResourceLocation("nopo:core/search.png");
    ...
    public NopoConfigEditor(Config config) {
        this(config, null);
    }

    public NopoConfigEditor(Config config, String categoryOpen) {
