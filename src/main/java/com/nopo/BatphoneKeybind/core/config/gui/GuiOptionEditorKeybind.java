...
import com.nopo.BatphoneKeybind.core.config.KeybindHelper;
...
import static com.nopo.BatphoneKeybind.util.GuiTextures.button_tex;

public class GuiOptionEditorKeybind extends GuiOptionEditor {

    private static final ResourceLocation RESET = new ResourceLocation("nopo:reset.png");
